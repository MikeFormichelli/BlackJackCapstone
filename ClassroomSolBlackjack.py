...
def play_game():
    ...
    def compare(user_score, computer_score):
        if user_score == computer_score:
            ...
            return "You have lost! Blackjack!"
        elif user_score == 0:
    ...
    # TODO Hint 7: Inside calculate_score() check for a blackjack (a hand with only 2 cards: ace + 10) and return 0 instead of the actual score. 0 will represent a blackjack in our game.

    # TODO Hint 8: Inside calculate_score() check for an 11 (ace). If the score is already over 21, remove the 11 and replace it with a 1. You might need to look up append() and remove().
    ...
    while not is_game_over:
        ...
        # TODO Hint 10: If the game has not ended, ask the user if they want to draw another card. If yes, then use the deal_card() function to add another card to the user_cards List. If no, then the game has ended.
